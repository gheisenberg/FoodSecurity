...
file_p = '/mnt/datadisk/data/Sentinel2/moz_grid/'
...
#loads stds and means from file
load_means_stds_f = '/mnt/datadisk2/preprocessed/all/996x996_c432_fillmean_rlocal channel mean_clipvoutlier2.5_normZ_f31213/means_stds'
